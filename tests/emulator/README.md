...
## Development environment and release process
 ...
 - create virtualenv with Flask and Stratux Emulator installed into it (latter is installed in
...
install it (`pip install emulator.tar.gz`), ensure that configuration file exists and
`EMULATOR_SETTINGS` environment variable points to it, ensure that user has access to the
